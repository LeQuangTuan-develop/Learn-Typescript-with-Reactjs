...
type TopMovieAction =
    | {
          type: TopMovieActionType.GET_TOP_MOVIES // neu de string se mat bot check case type safe o duoi
          payload: TopMovie[]
      }
    | { type: TopMovieActionType.TOGGLE_TOP_MOVIE_WATCHED; payload: string }
